...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/snowflake-ingest-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12381&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/snowflake-ingest-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `snowflake-ingest` can be installed with:

```
conda install snowflake-ingest
```

It is possible to list all of the versions of `snowflake-ingest` available on your platform with:
